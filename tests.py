...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_padding(self):
        ...
        try: self.assertEqual("".join(self.f3.transduce(x for x in "c")), "c000")
        except: s.append(4)
    ...
    def test_morphology(self):
        ...
        try: self.assertEqual(generate("spruce+ed"), "spruced")
        except: s.append(9)
        try: self.assertEqual(generate("picnic+ing"), "picnicking")
        except: s.append(10)
        try: self.assertEqual(generate("panic+ing"), "panicking")
        except: s.append(11)
